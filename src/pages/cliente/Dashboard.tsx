  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="relative z-10 flex flex-col gap-5">
          ...
          <div className="flex flex-row justify-between items-start w-full gap-3 sm:gap-4">
            ...
            <div className="flex flex-col items-start gap-2 flex-1 min-w-0">
              <div className="grid grid-cols-1 gap-2.5 sm:gap-3 text-sm w-full max-w-sm">
                {/* 1. Date Card */}
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-5 w-[90%] mx-auto sm:w-full">
        <Link to="/cliente/produtos" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
        ...
        <Link to="/cliente/servicos" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
          <div className="aspect-[4/3] relative overflow-hidden flex items-center justify-center w-full max-w-full">
        ...
        <Link to="/cliente/pedidos" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
          <div className="aspect-[4/3] relative overflow-hidden flex items-center justify-center w-full max-w-full">
        ...
        <Link to="/cliente/ordens-servico" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
          <div className="aspect-[4/3] relative overflow-hidden flex items-center justify-center w-full max-w-full">
        ...
        <Link to="/cliente/meus-contatos" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
          <div className="aspect-[4/3] relative overflow-hidden flex items-center justify-center w-full max-w-full">
        ...
        <Link to="/cliente/despesas-mensais" className="group flex flex-col bg-[#ffffff] rounded-2xl overflow-hidden transition-all duration-300 w-full max-w-full shadow-xs">
          <div className="aspect-[4/3] relative overflow-hidden flex items-center justify-center w-full max-w-full">
