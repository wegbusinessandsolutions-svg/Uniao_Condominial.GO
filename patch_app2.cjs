...
const targetImport = 'import ComercialComissoes from "./pages/comercial/Comissoes";';
...
const targetRoute = '<Route path="comissoes" element={<ComercialComissoes />} />';
const newRoute = '<Route path="afiliados" element={<ControleAfiliados />} />';
