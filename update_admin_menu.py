...
with open('src/components/layouts/AdminLayout.tsx', 'r') as f:
    content = f.read()
...
if target in content:
    ...
    with open('src/components/layouts/AdminLayout.tsx', 'w') as f:
        f.write(content)
    print("Success AdminLayout")
else:
    print("Target not found AdminLayout")
